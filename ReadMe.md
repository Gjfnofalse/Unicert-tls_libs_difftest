# Unicert - Testing of TLS Implementations

We provide the main analysis scripts and datasets used for testing of TLS implementations in our paper, "Analyzing Compliance and Complications of Integrating Internationalized X.509 Certificates."

This repository includes the following components:
1. **CertificateGenerator** – Script for generating test certificates.
2. **CertificateParsers** – Parsers developed for various TLS implementations.
3. **CertificateDecodingChecker** – Tools for inferring how ASN1String fields are decoded.
4. **EncodingDetection** – Tools for detecting encoding errors in ASN1String fields.
5. **TestCertificates/input.json** – A subset of Unicerts used in our experiments.
6. **ParsedCertificates/*.json** – Parsing results generated by different TLS parsers.

**Note: Due to the many edge cases in X.509 certificate field parsing, manual validation is often necessary. We may develop additional scripts in the future to help organize and analyze the test results.**
